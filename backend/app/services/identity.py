...
ROOM_NICKNAMES = {
    ...
    "lonely-miss": (["遥远的", "沉默的", "回望的"], ["灯塔", "信", "影子"]),
    "exhausted-blank": (["疲惫的", "放空的", "失语的"], ["石头", "雾", "休止符"]),
    "touched-warm": (["柔软的", "微光的", "温热的"], ["琥珀", "烛火", "回声"]),
    "nervous-hope": (["悬心的", "期待的", "绷紧的"], ["弦", "潮汐", "钟摆"]),
    "wronged-sad": (["哽咽的", "酸涩的", "低头的"], ["雨", "潮", "茧"]),
    "relief-letgo": (["轻盈的", "舒展的", "松开的"], ["羽", "云", "门"]),
}
